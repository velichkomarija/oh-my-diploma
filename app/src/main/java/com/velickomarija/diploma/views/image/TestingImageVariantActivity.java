...
import com.velickomarija.diploma.views.questionnaire.QuestionEnter2Activity;
import com.velickomarija.diploma.views.sound.TestingSoundActivity;

import java.util.HashMap;
import java.util.Map;

/**
 * Класс-активность, отвечающая за воспроизведение фигур пользователем.
 */
